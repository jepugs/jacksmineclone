...
-- mob constants. Times are in ticks
local BREED_TIME          = 
...
function mobs:register_mob(name, def)
	...
	minetest.register_entity(name, {
		...
		-- Called when the mob is right clicked with non-food item in hand. The
		-- function should return either the DONE or CONTINUE constant. If it
		-- returns CONTINUE, then on_interact behavior will be called
